...
namespace BookStoreManagement.API.Data.Migrations
{
    ...
    [Migration("20260607103016_RemoveSellingPriceFromImportDetails")]
    partial class RemoveSellingPriceFromImportDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStoreManagement.API.Models.Entities.BookAuthor", b =>
                {
                    b.Property<int>("BookId")
                        .HasColumnType("integer")
                        .HasColumnName("book_id");
            ...
            modelBuilder.Entity("BookStoreManagement.API.Models.Entities.DebtReport", b =>
                {
                    ...
                    b.Property<decimal>("ClosingDebt")
                        .HasColumnType("decimal(12,2)")
                        .HasColumnName("closing_debt");
                    ...
                    b.Property<decimal>("OpeningDebt")
                        .HasColumnType("decimal(12,2)")
                        .HasColumnName("opening_debt");
                    ...
                    b.HasIndex("Month", "Year", "CustomerId")
                        .IsUnique();

                    b.ToTable("debt_reports");
                });
            ...
            modelBuilder.Entity("BookStoreManagement.API.Models.Entities.InventoryReport", b =>
                {
                    b.Property<int>("ReportId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("BookStoreManagement.API.Models.Entities.Settings", b =>
                {
